...
QT_MOC_LITERAL(1, 6, 12), // "scoreClicked"
QT_MOC_LITERAL(2, 19, 0) // ""

    },
    "Score\0scoreClicked\0"
};
...
void Score::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Score::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Score::scoreClicked)) {
                *result = 0;
                return;
            }
        }
